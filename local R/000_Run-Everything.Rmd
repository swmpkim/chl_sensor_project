...
# Models + Graphics: All Reserves Combined; ISCO Only  

```{r, child = '09b_minimal_combinedReserves_ISCOOnly.Rmd'}
...
# Models: Individual Reserves; ISCO Only  

```{r, child = '10_minimal_indRes_ISCOOnly.Rmd'}
